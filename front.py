...
def main():
    ...
    model = st.radio("Choose a model : ", ('yolo-n', 'yolo-m', 'yolo-x', 'yolo-nms'), horizontal=True)
    ...
    if uploaded_file:
        ...
        if model == 'yolo-n':
            ...
            response = requests.post("http://localhost:30001/pred_yolonms", files=file, params=params)
        # else:
